...
public class Main {
    public static void main(String[] args) {
        ...
        int varK = Integer.valueOf("9235");
            //this line keeps not working due to the comma, should I parse it?
        ...
        //I predicted the result to be 3 because without using % the remainder is truncated,
        // thus 3 goes into 10 only 3 times wholly
    }
}